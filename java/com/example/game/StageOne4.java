...
public class StageOne4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stage_one4);
    ...
    private boolean isMatch(ImageView imageView, ImageView target) {
        ...
        } else if (imageView.getId() == R.id.peach1 && target.getId() == R.id.frame4) {
            return targetRect.contains((int) (imageViewCenterX + toleranceX), (int) (imageViewCenterY + toleranceY));
        } else if (imageView.getId() == R.id.coin1 && target.getId() == R.id.frame5) {
            return targetRect.contains((int) (imageViewCenterX + toleranceX), (int) (imageViewCenterY + toleranceY));
        }
