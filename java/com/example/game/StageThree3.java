...
public class StageThree3 extends AppCompatActivity {
    ...
    private boolean isMatch(ImageView imageView, ImageView target) {
        ...
        if (imageView.getId() == R.id.star1 && target.getId() == R.id.frame6) {
            ...
            return targetRect.contains((int) (imageViewCenterX + toleranceX), (int) (imageViewCenterY + toleranceY));
        } else if (imageView.getId() == R.id.coin1 && target.getId() == R.id.frame7) {
            return targetRect.contains((int) (imageViewCenterX + toleranceX), (int) (imageViewCenterY + toleranceY));
        } else if (imageView.getId() == R.id.moneystack1 && target.getId() == R.id.frame10) {
            return targetRect.contains((int) (imageViewCenterX + toleranceX), (int) (imageViewCenterY + toleranceY));
        } else if (imageView.getId() == R.id.honeypot1 && target.getId() == R.id.frame8) {
            return targetRect.contains((int) (imageViewCenterX + toleranceX), (int) (imageViewCenterY + toleranceY));
        }
