...
public class StageThree5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boxImageView5 = findViewById(R.id.box5);
        ...
        gameBoard = findViewById(R.id.gameboard3won);
        gameBoard2 = findViewById(R.id.gameboard3lose);
        ...
        imageViews.add(findViewById(R.id.honeypot1));

        targetViews.add(findViewById(R.id.frame6));
        targetViews.add(findViewById(R.id.frame7));
        targetViews.add(findViewById(R.id.frame8));
        targetViews.add(findViewById(R.id.frame9));
        targetViews.add(findViewById(R.id.frame10));
        ...
        button2.setOnClickListener(v -> {
            ...
            if (clickCount2 == 1 && allTargetsMatched()) {
                ...
                boxImageView5.setVisibility(View.INVISIBLE);
    ...
    private boolean isMatch(ImageView imageView, ImageView target) {
        ...
        if (imageView.getId() == R.id.star1 && target.getId() == R.id.frame7) {
            return targetRect.contains((int) (imageViewCenterX + toleranceX), (int) (imageViewCenterY + toleranceY));
        } else if (imageView.getId() == R.id.peach1 && target.getId() == R.id.frame9) {
            return targetRect.contains((int) (imageViewCenterX + toleranceX), (int) (imageViewCenterY + toleranceY));
        } else if (imageView.getId() == R.id.coin1 && target.getId() == R.id.frame8) {
            return targetRect.contains((int) (imageViewCenterX + toleranceX), (int) (imageViewCenterY + toleranceY));
        } else if (imageView.getId() == R.id.moneystack1 && target.getId() == R.id.frame10) {
            return targetRect.contains((int) (imageViewCenterX + toleranceX), (int) (imageViewCenterY + toleranceY));
        } else if (imageView.getId() == R.id.honeypot1 && target.getId() == R.id.frame6) {
            return targetRect.contains((int) (imageViewCenterX + toleranceX), (int) (imageViewCenterY + toleranceY));
        }
